...
- **End‑to‑end PDF translation** (`pdf_translator` package) with chunked processing, paragraph awareness, and page metadata.
...
- **PDF**: `data/input_translated.pdf`
- **Markdown**: `data/input_translated.md` and `data/input_translated_assets/`
...
- `pdf_translator/mcp_server.py`: MCP server that wraps LM Studio’s OpenAI‑compatible API. See [docs/MCP_README.md](docs/MCP_README.md) for standalone usage/tests.
